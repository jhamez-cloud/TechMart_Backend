...
class ProductFilter(django_filters.FilterSet):
    ...
    variant_id = django_filters.CharFilter(field_name='variants__id', lookup_expr='exact')
    id_in = django_filters.BaseInFilter(field_name='variants__id',lookup_expr='in')
